...
export default function Sidebar() {
    return (
        <aside className="flex flex-col fixed inset-y-0 items-center py-4 gap-1 shrink-0 w-14 border-r border-border bg-sidebar">
            ...
            <div className="flex-1 flex flex-col justify-end gap-1 px-2 w-full">
